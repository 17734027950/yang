...
class Ydb
{
    ...
    {
        $r = $this->exec($this->getNormalSQL($data, null, Ydb::QUERY_TYPE_INSERT));
        if ($r == 0)
        {
            return $r;
        }
    ...
    {
        return $this->exec($this->getNormalSQL($data, $conditions, Ydb::QUERY_TYPE_UPDATE));
    }
    ...
    {
        return $this->exec($this->getNormalSQL(null, $conditions, Ydb::QUERY_TYPE_DELETE));
    }
